...
path_external_drive = '/mnt/c/Users/Jan/Daten/Geschäftlich/Capgemini/scripts/tmp/'
# path_pneumonia_files = 'relevant_files/pneumonia/'
path_pneumonia_files = ''
...
relevant_files = [True if 'normal' in data[31] and 'abnormal' not in data[31] and data[9] != 'L' else False for data in meta_data.values]
